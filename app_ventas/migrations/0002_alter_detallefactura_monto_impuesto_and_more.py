    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("valor__gte", 0)), name="chk_descuento_valor_gte_0"
            ),
        ),
        migrations.AddConstraint(
            model_name="descuento",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("limite_usos__isnull", True),
                    ("veces_usado__lte", models.F("limite_usos")),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("factura", "producto"), name="uq_det_fac_producto"
            ),
        ),
        migrations.AddConstraint(
            model_name="devolucion",
            constraint=models.CheckConstraint(
                condition=models.Q(("total_devuelto__gt", 0)), name="chk_dev_total_gt_0"
            ),
        ),
        migrations.AddConstraint(
            model_name="devolucion",
        ...
        migrations.AddConstraint(
            model_name="factura",
            constraint=models.CheckConstraint(
                condition=models.Q(("total__gte", 0)), name="chk_factura_total_gte_0"
            ),
        ),
        migrations.AddConstraint(
            model_name="factura",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("monto__gt", 0)), name="chk_pago_monto_gt_0"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("ultimo_numero", 0),
                    models.Q(
                        ("ultimo_numero__gte", models.F("rango_desde")),
                        ("ultimo_numero__lte", models.F("rango_hasta")),
                    ),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            model_name="resoluciondian",
            constraint=models.CheckConstraint(
                condition=models.Q(("numero_resolucion", ""), _negated=True),
